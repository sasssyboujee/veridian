...
4. **Buy Physical Assets:** On the **Secondary Market** page, they can use their `mUSDC` to purchase tokens representing fractional ownership of *Solar Plant Alpha* or *Farmstead Harvester Beta*.
